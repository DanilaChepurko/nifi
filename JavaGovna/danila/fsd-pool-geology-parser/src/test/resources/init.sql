...
create table if not exists public.pool_geology (
    ...
    depth NUMERIC(19, 6) NOT NULL,
    low_perm_thin BOOLEAN NOT NULL,
    low_perm_thick BOOLEAN NOT NULL,
